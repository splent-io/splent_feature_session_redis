"""
End-to-end tests for splent_feature_session_redis.
...
Run with:  splent feature:test splent_feature_session_redis --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_session_redis")
    assert "splent_feature_session_redis" in browser.page_source.lower()
